...
def main():
  ...
  if "kickstart" in arguments.keys() and arguments['kickstart']:
    kickstart = open(arguments['kickstartlocation'], "w")
...
def processArgs():
  ...
  parser.add_option('--kickstart', '-k', help="Specify a location to push the kickstart packages to, i.e. /var/www/html/updaterpm.rhel6w-complete")
